...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 py-4 px-4">
        <form method="post" enctype="multipart/form-data" action="{{route('edit-jurusan',$jurusan->jur_id)}}">
            @csrf
            @method("PUT")
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="{{$jurusan->nama_jurusan}}" name="nama_jurusan">
                        </div>
                    </div>
                </div>
            </div>
